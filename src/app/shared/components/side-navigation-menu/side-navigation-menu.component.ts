...
import { navigation_vendeur } from '../../../app-navigation-vendeur';
...
export class SideNavigationMenuComponent implements AfterViewInit, OnDestroy {
  ...
  get items() {
    if (!this._items) {
      if (this.authenticationService.getUserFunction() == "vendeur") {
         this._items = navigation_vendeur.map((item) => ({ ...item, expanded: !this._compactMode }));
      } else{
